...
class FantasyFootballPipeline:
    ...
    def create_pipeline(self) -> Pipeline:
        ...
        league_id_param = ParameterString(
            name="LeagueID",
            default_value="your-league-id"
        )
        
        user_id_param = ParameterString(
            name="UserID",
            default_value="your-user-id"
        )
...
"""
        ...
        step = ProcessingStep(
            ...
            job_arguments=[
                "--code-file", "/opt/ml/processing/input/code/process_sleeper.py"
            ],
            environment={
...
"""
        ...
        step = ProcessingStep(
            ...
            job_arguments=[
                "--code-file", "/opt/ml/processing/input/code/process_nfl.py"
            ],
            environment={
                "SEASON": season_param,
                "WEEK": week_param
    ...
    def _create_data_processing_step(
        self,
        sleeper_step: ProcessingStep,
        nfl_step: ProcessingStep
    ) -> ProcessingStep:
...
"""
        ...
        step = ProcessingStep(
            ...
            job_arguments=[
                "--code-file", "/opt/ml/processing/input/code/process_combined.py"
            ]
        )
