...
@click.option('--num-lineups', type=int, default=3, help='Number of lineups to generate')
@click.option('--objective', type=click.Choice(['points', 'ceiling', 'floor']), default='points', help='Optimization objective')
def analyze(league_id, user_id, week, output_dir, pull_data, optimize_lineup, analyze_trades, waiver_wire, full_analysis, num_lineups, objective):
...
@click.option('--num-lineups', type=int, default=3, help='Number of lineups to generate')
@click.option('--objective', type=click.Choice(['points', 'ceiling', 'floor']), default='points', help='Optimization objective')
@click.option('--output', default='data/processed/optimized_lineups.json', help='Output file')
...
@click.option('--output', default='data/processed/trade_analysis.json', help='Output file')
...
@click.option('--output', default='data/processed/waiver_analysis.json', help='Output file')
