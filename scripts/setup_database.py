...
from fantasy_football_2025.database.setup import setup_database, reset_database, verify_database_setup, get_database_info
...
def main():
    ...
    if not any([args.setup, args.reset, args.verify, args.info, args.create_sample_data]):
        parser.print_help()
        return
